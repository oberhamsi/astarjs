...
var {findRoute} = require('astarjs');
var {point} = require('astarjs/point');
...
exports.testSomething = function () {
   assert.deepEqual(findRoute(point(0, 0), point(19, 19)), ROUTE_A);
   assert.deepEqual(findRoute(point(0, 0), point(11, 17)), ROUTE_B);
   assert.deepEqual(findRoute(point(11, 17), point(19, 19)), ROUTE_C);
